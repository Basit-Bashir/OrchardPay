...
function GrowerPrintInner({ params }: { params: Promise<{ id: string }> }) {
  ...
  const statementData = useMemo(() => {
    ...
    return { ledger, totalGrossValue, totalExpensesDeducted, totalCredit, totalPaymentsTaken, totalItemCharges, openingBalance, netBalance: runningBalance };
  }, [data, statementType, startDate, endDate, selectedTxnId]);

  const { ledger, totalGrossValue, totalExpensesDeducted, totalCredit, totalPaymentsTaken, totalItemCharges, openingBalance, netBalance } = statementData;
    ...
    <Box minH="100vh" bg="white" color="gray.800" position="relative" p={8} fontSize="sm">
      ...
      <Box className="no-print" bg="gray.50" p={4} borderRadius="xl" mb={8} borderWidth="1px" borderColor="gray.200" shadow="sm">
        <Flex justify="space-between" align="center" wrap="wrap" gap={4}>
          ...
          <Flex gap={3} align="flex-end">
            <Button colorPalette="green" size="sm" h="32px" onClick={() => window.print()}>Print Statement</Button>
      ...
      <Box position="relative" zIndex={1}>
        <Flex justify="space-between" align="center" borderBottomWidth="2px" borderColor="green.800" pb={6} mb={8}>
          ...
          <Box textAlign="right">
            <Text fontWeight="bold" fontSize="lg" color="gray.700">{statementType === "single" ? "Delivery Invoice" : "Statement Ledger"}</Text>
        ...
        <SimpleGrid columns={2} gap={8} mb={8}>
          ...
          <Box p={4} borderRadius="lg" bg="gray.50" borderWidth="1px">
            ...
            <SimpleGrid columns={2} gap={2} fontSize="xs">
              ...
              <Text fontWeight="semibold" textAlign="right" color="red.650">{inr(totalExpensesDeducted)}</Text>
